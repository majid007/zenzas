 ...
 * t_carroceria_auto
 *
 * @ORM\Table(name="t_carroceria_auto")
 * @ORM\Entity(repositoryClass="Test\FrontBundle\Repository\t_carroceria_autoRepository")
 */
class t_carroceria_auto
{
    /**
     * @var int
     *
